...
//																	BAT,				  ANTENNA,			 IDLE,				FLASH,			   TRANS,			  ATTI,				 LOWP,			PERSIST
#define INITIAL_TASK_STATES					((struct task_states) {T_STATE_RUNNING,   T_STATE_SUSPENDED, T_STATE_SUSPENDED, T_STATE_SUSPENDED, T_STATE_SUSPENDED, T_STATE_RUNNING,   T_STATE_SUSPENDED, T_STATE_RUNNING})
#define ANTENNA_DEPLOY_TASK_STATES			((struct task_states) {T_STATE_RUNNING,   T_STATE_ANY,		 T_STATE_SUSPENDED, T_STATE_SUSPENDED, T_STATE_SUSPENDED, T_STATE_RUNNING,   T_STATE_SUSPENDED, T_STATE_RUNNING})
#define HELLO_WORLD_TASK_STATES				((struct task_states) {T_STATE_RUNNING,	  T_STATE_ANY,		 T_STATE_RUNNING,	T_STATE_SUSPENDED, T_STATE_RUNNING,	  T_STATE_RUNNING,   T_STATE_SUSPENDED, T_STATE_RUNNING})
#define HELLO_WORLD_LOW_POWER_TASK_STATES	((struct task_states) {T_STATE_RUNNING,	  T_STATE_SUSPENDED, T_STATE_SUSPENDED,	T_STATE_SUSPENDED, T_STATE_RUNNING,	  T_STATE_SUSPENDED, T_STATE_RUNNING,	T_STATE_RUNNING})
#define IDLE_NO_FLASH_TASK_STATES			HELLO_WORLD_TASK_STATES
#define IDLE_FLASH_TASK_STATES				((struct task_states) {T_STATE_RUNNING,	  T_STATE_ANY,		 T_STATE_RUNNING,	T_STATE_RUNNING,   T_STATE_RUNNING,	  T_STATE_RUNNING,   T_STATE_SUSPENDED, T_STATE_RUNNING})
