...
#define LOW_POWER_TASK_STATES			((struct task_states) {T_STATE_RUNNING,	  T_STATE_SUSPENDED, T_STATE_SUSPENDED,	T_STATE_SUSPENDED, T_STATE_RUNNING,	  T_STATE_SUSPENDED, T_STATE_RUNNING})
