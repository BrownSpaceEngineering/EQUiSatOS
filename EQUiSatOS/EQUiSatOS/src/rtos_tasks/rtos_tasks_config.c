...
void assert_rtos_constants() {
	...
	int idle_all_loops_per_log[] = {
		idle_LION_VOLTS_DATA_ARR_LEN,
		idle_LION_CURRENT_DATA_ARR_LEN,
		idle_BAT_CHARGE_VOLTS_DATA_ARR_LEN,
		idle_BAT_CHARGE_DIG_SIGS_DATA_ARR_LEN,
		idle_DIGITAL_OUT_DATA_ARR_LEN,
		idle_BAT_TEMP_DATA_ARR_LEN,
		idle_RADIO_TEMP_DATA_ARR_LEN,
		idle_RADIO_VOLTS_DATA_ARR_LEN,
		idle_IMU_TEMP_DATA_ARR_LEN,
		idle_IR_TEMPS_DATA_ARR_LEN,
		idle_RAIL_3V_DATA_ARR_LEN,
		idle_RAIL_5V_DATA_ARR_LEN};
	uint16_t idle_max_loops_per_log = arrMax(idle_all_loops_per_log, 12); // max of the above (MAKE SURE TO UPDATE IF YOU ADD)
	...
	assert(idle_IMU_TEMP_DATA_ARR_LEN == idle_IMU_TEMP_LOOPS_PER_LOG / idle_max_loops_per_log);
	assert(idle_IR_TEMPS_DATA_ARR_LEN == idle_IR_TEMPS_LOOPS_PER_LOG / idle_max_loops_per_log);
	assert(idle_RAIL_3V_DATA_ARR_LEN == idle_RAIL_3V_LOOPS_PER_LOG / idle_max_loops_per_log);
	assert(idle_RAIL_5V_DATA_ARR_LEN == idle_RAIL_5V_LOOPS_PER_LOG / idle_max_loops_per_log);
	...
	assert(idle_IMU_TEMP_LOOPS_PER_LOG >= 1);
	assert(idle_IR_TEMPS_LOOPS_PER_LOG >= 1);
	assert(idle_RAIL_3V_LOOPS_PER_LOG >= 1);
	assert(idle_RAIL_5V_LOOPS_PER_LOG >= 1);
