...
#endif
	#define ANTENNA_DEPLOY_LI_NOT_CHARGED_WAIT		1800000
	#define ANTENNA_DEPLOY_LF_NOT_CHARGED_WAIT		3600000
	#define ANTENNA_DEPLOY_TASK_WATCHDOG_TIMEOUT	(Max(ANTENNA_DEPLOY_LI_NOT_CHARGED_WAIT, ANTENNA_DEPLOY_LF_NOT_CHARGED_WAIT, ANTENNA_DEPLOY_TASK_LESS_FREQ))
