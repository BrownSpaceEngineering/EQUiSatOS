...
#define LOW_POWER_DATA_PACKET_SIZE	33
...
// size of padding after each packet (loss of above precision is INTENTIONAL)
#define IDLE_DATA_PADDING_SIZE			(MSG_DATA_AND_ERRORS_LEN - IDLE_DATA_NUM_ERRORS * ERROR_PACKET_SIZE)
#define ATTITUDE_DATA_PADDING_SIZE		(MSG_DATA_AND_ERRORS_LEN - ATTITUDE_DATA_NUM_ERRORS * ERROR_PACKET_SIZE)
#define FLASH_DATA_PADDING_SIZE			(MSG_DATA_AND_ERRORS_LEN - FLASH_DATA_NUM_ERRORS * ERROR_PACKET_SIZE)
#define FLASH_CMP_DATA_PADDING_SIZE		(MSG_DATA_AND_ERRORS_LEN - FLASH_CMP_DATA_NUM_ERRORS * ERROR_PACKET_SIZE)
#define LOW_POWER_DATA_PADDING_SIZE		(MSG_DATA_AND_ERRORS_LEN - LOW_POWER_DATA_NUM_ERRORS * ERROR_PACKET_SIZE)
