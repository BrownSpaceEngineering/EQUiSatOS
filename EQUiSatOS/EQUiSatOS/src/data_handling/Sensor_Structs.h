...
typedef uint16_t lion_temps_batch			[2];
typedef uint16_t led_temps_batch				[4];
typedef uint16_t lifepo_current_batch		[4];
typedef uint16_t lifepo_volts_batch			[4];
typedef uint16_t lifepo_bank_temps_batch		[2];
typedef uint16_t ir_ambient_temps_batch		[6];
typedef uint16_t radio_temp_batch;			// single value
typedef uint16_t radio_current_batch;		// single value
typedef uint16_t radio_volts_batch;			// single value
...
typedef uint16_t pdiode_batch				[6];
