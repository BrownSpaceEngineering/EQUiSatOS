...
//typedef uint8_t lifepo_current_batch		[4]; // UNTIL we do truncating
typedef uint16_t lifepo_current_batch		[4];
//typedef uint8_t lifepo_volts_batch			[4]; // UNTIL we do truncating
typedef uint16_t lifepo_volts_batch			[4];
//typedef uint8_t led_current_batch			[4]; // UNTIL we do truncating
