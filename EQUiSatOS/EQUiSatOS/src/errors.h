...
/**** ATMEL DEFINED ****/
	...
	ECODE_UNEXPECTED_CASE_1 = 			33,
	ECODE_UNEXPECTED_CASE_2 = 			34,
	ECODE_UNEXPECTED_CASE_3 = 			35,
	ECODE_UNEXPECTED_CASE_4 = 			36,
	ECODE_UNEXPECTED_CASE_5 = 			37,
	ECODE_UNEXPECTED_CASE_6 = 			38,
	ECODE_UNEXPECTED_CASE_7 = 			39,
	ECODE_UNEXPECTED_CASE_8 = 			40,
	ECODE_UNEXPECTED_CASE_9 = 			41,
	ECODE_UNEXPECTED_CASE_10 = 			42,
	ECODE_WATCHDOG_EARLY_WARNING =		43,
	ECODE_WATCHDOG_RESET =				44,
	ECODE_WATCHDOG_DID_KICK =			45,
	ECODE_EXCESSIVE_SUSPENSION =		46,

	ECODE_CRIT_ACTION_MUTEX_TIMEOUT =	47,
	ECODE_I2C_MUTEX_TIMEOUT =			48,
	ECODE_PROC_ADC_MUTEX_TIMEOUT =		49,
	ECODE_HW_STATE_MUTEX_TIMEOUT =		50,
	ECODE_USART_MUTEX_TIMEOUT =			51,
	ECODE_SPI_MUTEX_TIMEOUT =			52,
	ECODE_BAT_CHARGING_MUTEX_TIMEOUT =  53,
	ECODE_WATCHDOG_MUTEX_TIMEOUT =		54,
	ECODE_EQUISTACK_MUTEX_TIMEOUT =		55,
	ECODE_IRPOW_MUTEX_TIMEOUT =			56,

	ECODE_REWROTE_PROG_MEM =			57,
	ECODE_STACK_OVERFLOW =				58,
	ECODE_DET_ALREADY_HIGH =			59,

	ECODE_BAT_NOT_DISCHARGING =         60,
	ECODE_BAT_NOT_NOT_DISCHARGING =     61,
	ECODE_BAT_NOT_CHARGING =			62,
	ECODE_BAT_NOT_NOT_CHARGING =		63,
	ECODE_BAT_NOT_DISCHARGING_RESTART = 64,
	ECODE_BAT_FAULT =                   65,
	ECODE_NOT_FULL_FOR_WHILE =          66,
	ECODE_LOW_VOLTAGE_FOR_WHILE =       67,
	ECODE_RECOMMISSION =                68,
	ECODE_ALL_SAME_VAL =				69,
	ECODE_CORRUPTED =					70,
	ECODE_INVALID_STATE_CHANGE =		71,
	ECODE_TIMESTAMP_WRAPAROUND =		72,
	ECODE_PWM_CUR_LOW_ON_DEPLOY =		73,
	ECODE_PWM_CUR_LOW_ON_MAX_CYCLE =	74,
	ECODE_PWM_CUR_VERY_LOW_ON_DEPLOY =	75,
	ECODE_PWM_CUR_VERY_LOW_ON_MAX_CYCLE = 76
};
